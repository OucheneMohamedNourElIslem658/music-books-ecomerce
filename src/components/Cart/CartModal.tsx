        ...
        {!hasItems ? (
          ...
          <div className="flex flex-col flex-1 overflow-hidden">
                  ...
                  const imageVariant = product.gallery?.find((item: any) => {
                    ...
                    const variantOptionID =
                      typeof item.variantOption === 'object'
                        ? item.variantOption.id : item.variantOption
            ...
            <div className="px-6 py-5 flex flex-col gap-5 bg-card/30">
              ...
              <Button
                asChild
                className="w-full rounded-full h-13 font-black uppercase tracking-widest text-sm shadow-lg shadow-primary/20 hover:shadow-primary/30 hover:scale-[1.02] active:scale-[0.98] transition-all"
              >
                <Link href="/checkout">
                  Embark on Checkout
                </Link>
