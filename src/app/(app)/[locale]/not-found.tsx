...
export default function NotFound() {
  ...
  return (
    <main className="grow flex items-center justify-center p-6 relative overflow-hidden min-h-screen bg-background text-foreground">
      {/* Background */}
      ...
      <div className="max-w-2xl w-full flex flex-col items-center text-center gap-8 relative z-10">
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="flex flex-col items-center gap-3">
            <p className="text-[10px] font-black text-primary/60 uppercase tracking-[0.3em]">{t('helpText')}</p>
