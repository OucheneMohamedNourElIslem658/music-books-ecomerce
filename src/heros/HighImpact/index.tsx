...
export const HighImpactHero: React.FC<Props> = ({
  ...
  return (
    <div className="container py-8 md:py-12">
      <section className="relative bg-card/50 border border-border rounded-[2.5rem] overflow-hidden backdrop-blur-md shadow-sm magical-gradient">
        ...
        <div className="@container">
          <div className="flex flex-col gap-10 px-8 py-12 lg:flex-row lg:items-center min-h-150">
            ...
            <div className="w-full relative group lg:w-1/2 max-w-125 mx-auto lg:mx-0">
              ...
              <div className="relative aspect-4/5 w-full overflow-hidden rounded-4xl border-4 border-border/10 shadow-md transform hover:scale-[1.01] transition-transform duration-500 bg-muted">
